...
<body>
      <div class="container">
        ...
        ?>
            ...
            <header>Registracija v portal FarmIQ</header>
            <form action="" method="post">
                ...
                <div class="field">
                    ...
                    <input type="submit" class="btn" name="submit" value="Registriraj se" required>
                </div>
                <div class="links">
                    Že registrirani? <a href="index2.php">Registriraj se</a>
                </div>
            </form>
        </div>
        <?php } ?>

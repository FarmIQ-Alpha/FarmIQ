    ...
    <div class="container">
        <div class="box form-box">
            <?php 
               if(isset($_POST['submit'])){
                ...
                if($edit_query){
                    ...
                    <p>Profil posodobljen!</p>
                </div> <br>";
              echo "<a href='home.php'><button class='btn'>Domov</button>";
            ...
            <form action="" method="post">
                ...
                <div class="field input">
                    <label for="age">Količina obdelovalnih površin</label>
                    <input type="number" name="age" id="age" value="<?php echo $res_Age; ?>" autocomplete="off" required>
                </div>
                
                <div class="field">
                    
                    <input type="submit" class="btn" name="submit" value="Posodobi" required>
                </div>
